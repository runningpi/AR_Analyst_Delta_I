...
from Decomposition_AR.ocr_docling_utils import DoclingParser
from Decomposition_AR.text_mangement_utils import TextManager, ClassificationManager, EvaluationManager
from Decomposition_AR.classification_service import ClassificationService
from RAG_and_knowledgebase.DS_RAG_utils import KnowledgeBaseManager
from RAG_and_knowledgebase.matching_utils import SentenceMatcher
from Evaluation.evaluation_utils import EvaluationService
from core.analysis import EvaluationAnalyzer, ReportGenerator
...
class ARAnalysisPipeline:
    ...
    def classify_sentences(
        ...
        classification_cache_dir = Path(__file__).parent.parent / "Decomposition_AR" / "output" / "classified_sentences"
    ...
    def match_sentences(
        ...
        rag_cache_dir = Path(__file__).parent.parent / "RAG_and_knowledgebase" / "output"
    ...
    def evaluate_sentences(
        ...
        # Setup cache directory
        evaluation_cache_dir = Path(__file__).parent.parent / "Evaluation" / "output"
    ...
    def analyze_and_report(
        ...
        analysis_output_dir = Path(__file__).parent.parent / "Analysis" / "output"
    ...
    def run_full_pipeline(
        ...
        try:
            ...
            if text_dict is not None:
                ...
                from pathlib import Path
                # Note: pipeline.py is now in core/, so go up one level to reach Decomposition_AR
                ocr_output_dir = Path(__file__).parent.parent / "Decomposition_AR" / "ocr_content"
